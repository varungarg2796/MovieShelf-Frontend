...
const WatchList: React.FC = () => {
    ...
    return (
        <>
            ...
            >
                {items.map((item: any) => (
                    <div key={item.imdbid.title} className="movie-card flex flex-col items-center justify-center p-4 bg-white rounded-lg shadow-lg">
                        <img src={item.imdbid.poster} alt={item.imdbid.title} className="w-full h-48 object-cover rounded-lg mb-2" />
            ...
            <div className="flex flex-col items-center bg-gray-100">
                <div className="p-6 bg-white rounded-xl shadow-md flex items-center space-x-4">
                    <div>
                        ...
                        <h2 className="text-xl font-normal text-gray-900">Total Watchlist duration: <span className="font-normal text-blue-600">{totalWatchlistDuration} minutes</span> or <span className="font-normal text-blue-600">{(totalWatchlistDuration / 60).toFixed(1)} hours</span></h2>
                        <h2 className="text-xl font-normal text-gray-900">It will take you approximately <span className="font-normal text-blue-600">{(totalWatchlistDuration / (60 * 24)).toFixed(1)} days</span> to watch it all!</h2>
                    </div>
                </div>
            </div>
